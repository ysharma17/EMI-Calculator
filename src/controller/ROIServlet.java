...
public class ROIServlet extends HttpServlet {
    ...
    public void doPost(HttpServletRequest request, 
                       ...
                       out.println("<html>");
                       out.println("<head><title>PartialPrepaymentServlet</title></head>");
                       out.println("<body>");
                       ...
                       try 
                       {
               			if(rs.next())
               			{
               				...
               				lpd.setStatus(rs.getInt("status"));
               	            ...
               	            rd=request.getRequestDispatcher("/ShowROISchedule.jsp");
